---
name: aura-code-review
description: Systematic code review methodology — 4 layers of analysis with severity classification and confidence thresholds. Load this before auditing any code.
---
...
4. **Philosophy Check** — Also load `aura-code-philosophy` or `aura-frontend-philosophy` if applicable
